...
### ID: n0
#### Key feature:
Push/pull solenoid. Når den får strøm skubber den nogle mm fremad. Når strømmen stopper falder den tilbage på plads. I denne form skal man være lidt kreativ for at finde ud af hvad man kan bruge den til. f.eks. kan man tag en xylofon og sætte en solenoid over hver knap, og så kan man skrive kode der får den til at spille sange automatisk. God til f.eks. haptisk eller akustisk feedback

- 5v (hvis du kun har 1/2 stykker behøves du ikke ekstern strøm)
- Benyt en mosfet motor driver: http://adafru.it/5648 (m7)
- indsæt motorens 2 ledninger i den.
- driveren har 3 ledninger. den hvide skal i board signal, f.eks. a1.
- den røde skal til board 5v
- den sorte skal til board GND
...
Men der skal benyttes en driver med H-bridge....
